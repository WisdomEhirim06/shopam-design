        ...
        <div className="relative z-10 flex flex-col justify-center h-full p-8 lg:p-16 text-white">
          ...
          >
            ...
            <p className="text-xl opacity-90 mb-8 max-w-md">
              Find trusted vendors, browse local products and product shop securely.
            </p>
          </motion.div>
          ...
          >
            {[
              { icon: Shield, text: 'Browse local vendors in your area' },
              { icon: ShoppingBag, text: 'Read reviews and discover great products' },
              { icon: Zap, text: 'Connect with 1,000+ local Businesses' },
            ].map((feature, index) => (
