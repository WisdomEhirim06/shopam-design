...
export default function CategoryPills() {
  return (
    <section className="bg-canvas px-2 sm:px-4 pb-8 sm:pb-16 pt-1 sm:pt-2">
      ...
      >
        {homeCategories.map((category) => (
          <Link
            ...
            className="group flex shrink-0 items-center gap-1.5 sm:gap-2 rounded-full border border-slate-200/90 bg-white py-1 pl-1 pr-3 sm:pr-3.5 text-xs sm:text-[13px] font-bold text-slate-700 shadow-2xs transition-all hover:-translate-y-0.5 hover:border-slate-300 hover:shadow-xs whitespace-nowrap"
          >
