    ...
    <div className="space-y-8">
      ...
      >
        <div className="inline-flex p-6 bg-crimson/20 rounded-2xl mb-6">
          <MessageSquare size={48} className="text-crimson" />
        </div>
        <h2 className="text-2xl font-bold mb-3">Messages & Chat</h2>
        <p className="text-gray-400 max-w-md mx-auto">
          COMING SOON:
          This page will enable real-time messaging with customers and support team.
        </p>
      </motion.div>
    </div>
  );
